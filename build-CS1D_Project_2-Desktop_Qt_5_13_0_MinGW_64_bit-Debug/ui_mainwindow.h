...
public:
    ...
    QTextBrowser *textBrowserShortestPath;
    QLabel *label_3;
    QLabel *label_4;
    QPushButton *pushButtonDodgerStadium;
    QComboBox *comboBoxShortestPath;
    QLabel *label_5;
    QLabel *label_6;
    ...
    QWidget *purchaseSouvenirsScreen;
    QPushButton *pushButtonExitFromPurchaseSouvenirsScreen;
    QTableView *tableView;
    QComboBox *comboBoxTripListStadiums;
    QLabel *labelSelectedSouvenir;
    QLabel *labelSelectedSouvenirPrice;
    QSpinBox *spinBoxPurchaseQuantity;
    QPushButton *pushButtonBuy;
    QLabel *labelShowTotalPrice;
...
"font: 8pt \"Courier\";"));
        ...
        textBrowserShortestPath = new QTextBrowser(ShortestTripScreen);
        textBrowserShortestPath->setObjectName(QString::fromUtf8("textBrowserShortestPath"));
        textBrowserShortestPath->setGeometry(QRect(10, 10, 381, 511));
        label_3 = new QLabel(ShortestTripScreen);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(430, 130, 41, 20));
        label_4 = new QLabel(ShortestTripScreen);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(430, 190, 41, 16));
        ...
        pushButtonDodgerStadium->setGeometry(QRect(480, 120, 181, 41));
        comboBoxShortestPath = new QComboBox(ShortestTripScreen);
        comboBoxShortestPath->setObjectName(QString::fromUtf8("comboBoxShortestPath"));
        comboBoxShortestPath->setGeometry(QRect(480, 180, 181, 41));
        label_5 = new QLabel(ShortestTripScreen);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(440, 60, 251, 31));
        QFont font5;
        font5.setPointSize(9);
        label_5->setFont(font5);
        label_6 = new QLabel(ShortestTripScreen);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setGeometry(QRect(440, 270, 281, 31));
        ...
        pushButtonMarlinsPark->setGeometry(QRect(490, 310, 171, 41));
        label_7 = new QLabel(ShortestTripScreen);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(430, 430, 91, 16));
        labelShorestDistance = new QLabel(ShortestTripScreen);
        labelShorestDistance->setObjectName(QString::fromUtf8("labelShorestDistance"));
        labelShorestDistance->setGeometry(QRect(540, 420, 151, 41));
        labelShorestDistance->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        ...
        purchaseSouvenirsScreen = new QWidget();
        purchaseSouvenirsScreen->setObjectName(QString::fromUtf8("purchaseSouvenirsScreen"));
        pushButtonExitFromPurchaseSouvenirsScreen = new QPushButton(purchaseSouvenirsScreen);
        pushButtonExitFromPurchaseSouvenirsScreen->setObjectName(QString::fromUtf8("pushButtonExitFromPurchaseSouvenirsScreen"));
        pushButtonExitFromPurchaseSouvenirsScreen->setGeometry(QRect(640, 20, 93, 28));
        tableView = new QTableView(purchaseSouvenirsScreen);
        tableView->setObjectName(QString::fromUtf8("tableView"));
        tableView->setGeometry(QRect(30, 30, 341, 471));
        comboBoxTripListStadiums = new QComboBox(purchaseSouvenirsScreen);
        comboBoxTripListStadiums->setObjectName(QString::fromUtf8("comboBoxTripListStadiums"));
        comboBoxTripListStadiums->setGeometry(QRect(390, 30, 181, 22));
        labelSelectedSouvenir = new QLabel(purchaseSouvenirsScreen);
        labelSelectedSouvenir->setObjectName(QString::fromUtf8("labelSelectedSouvenir"));
        labelSelectedSouvenir->setGeometry(QRect(400, 140, 221, 16));
        labelSelectedSouvenir->setFrameShape(QFrame::Box);
        labelSelectedSouvenirPrice = new QLabel(purchaseSouvenirsScreen);
        labelSelectedSouvenirPrice->setObjectName(QString::fromUtf8("labelSelectedSouvenirPrice"));
        labelSelectedSouvenirPrice->setGeometry(QRect(400, 180, 221, 16));
        labelSelectedSouvenirPrice->setFrameShape(QFrame::Box);
        spinBoxPurchaseQuantity = new QSpinBox(purchaseSouvenirsScreen);
        spinBoxPurchaseQuantity->setObjectName(QString::fromUtf8("spinBoxPurchaseQuantity"));
        spinBoxPurchaseQuantity->setGeometry(QRect(580, 220, 42, 22));
        spinBoxPurchaseQuantity->setMaximum(1000000);
        pushButtonBuy = new QPushButton(purchaseSouvenirsScreen);
        pushButtonBuy->setObjectName(QString::fromUtf8("pushButtonBuy"));
        pushButtonBuy->setGeometry(QRect(540, 270, 93, 28));
        labelShowTotalPrice = new QLabel(purchaseSouvenirsScreen);
        labelShowTotalPrice->setObjectName(QString::fromUtf8("labelShowTotalPrice"));
        labelShowTotalPrice->setGeometry(QRect(464, 350, 171, 16));
        labelShowTotalPrice->setFrameShape(QFrame::Box);
        stackedWidget->addWidget(purchaseSouvenirsScreen);
        ...
        tableviewAllSouvenirs->setFont(font6);
        ...
        tableViewAllStadiumsADMIN->setFont(font6);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_4->setText(QCoreApplication::translate("MainWindow", "End:", nullptr));
        pushButtonDodgerStadium->setText(QCoreApplication::translate("MainWindow", "Dodger Stadium", nullptr));
        label_5->setText(QCoreApplication::translate("MainWindow", "Dijkstra's Starting At Dodger Stadium ", nullptr));
        label_6->setText(QCoreApplication::translate("MainWindow", "Shortest Path Starting From Marlins Path", nullptr));
        pushButtonMarlinsPark->setText(QCoreApplication::translate("MainWindow", "Marlins Park", nullptr));
        ...
        pushButtonExitFromPurchaseSouvenirsScreen->setText(QCoreApplication::translate("MainWindow", "Done", nullptr));
        labelSelectedSouvenir->setText(QString());
        labelSelectedSouvenirPrice->setText(QString());
        pushButtonBuy->setText(QCoreApplication::translate("MainWindow", "Buy", nullptr));
        labelShowTotalPrice->setText(QString());
