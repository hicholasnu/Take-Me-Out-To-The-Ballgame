...
public:
    ...
    QWidget *customScreen;
    QPushButton *pushButtonMainWin;
...
"font: 8pt \"Courier\";"));
        ...
        gridLayoutWidget->setGeometry(QRect(520, 50, 211, 184));
        ...
        formLayoutWidget->setGeometry(QRect(520, 240, 229, 275));
        ...
        pushButtonPlan = new QPushButton(UserScreen);
        pushButtonPlan->setObjectName(QString::fromUtf8("pushButtonPlan"));
        pushButtonPlan->setGeometry(QRect(380, 490, 121, 32));
        stackedWidget->addWidget(UserScreen);
        customScreen = new QWidget();
        customScreen->setObjectName(QString::fromUtf8("customScreen"));
        pushButtonMainWin = new QPushButton(customScreen);
        pushButtonMainWin->setObjectName(QString::fromUtf8("pushButtonMainWin"));
        pushButtonMainWin->setGeometry(QRect(10, 0, 61, 31));
        pushButtonLogOut = new QPushButton(customScreen);
        pushButtonLogOut->setObjectName(QString::fromUtf8("pushButtonLogOut"));
        pushButtonLogOut->setGeometry(QRect(70, 0, 71, 32));
        tableViewCustom = new QTableView(customScreen);
        tableViewCustom->setObjectName(QString::fromUtf8("tableViewCustom"));
        tableViewCustom->setGeometry(QRect(20, 50, 381, 381));
