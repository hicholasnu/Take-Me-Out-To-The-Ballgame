...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonLogout = new QPushButton(AdminScreen);
        pushButtonLogout->setObjectName(QString::fromUtf8("pushButtonLogout"));
        pushButtonLogout->setGeometry(QRect(562, 390, 191, 28));
        ...
        comboBoxStadiumNames->setGeometry(QRect(170, 480, 141, 22));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonLogout->setText(QApplication::translate("MainWindow", "Logout", nullptr));
