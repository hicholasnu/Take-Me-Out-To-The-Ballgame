...
int Dijkstra::getIndex(QString name)
{
    int temp = 0;
    for (int i = 0; i < 30; i++)
    {
...
void orderPath(QVector<Edge>&tp)
{
//    Edge min;
//    int minIndex = 0;
...
//        {
//            if (tp.at(j).weight < tp.at(minIndex).weight)
//            {
//                minIndex = j;
//            }
//        }
//        min.str = tp.at(minIndex).str;
//        min.end = tp.at(minIndex).end;
//        min.weight = tp.at(minIndex).weight;
//        QVector<Edge>temp;
//        temp.push_back(min);
//        tp.replace(minIndex, tp.at(i));
//        tp.replace(i,temp.at(minIndex));
